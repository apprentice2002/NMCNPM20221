...
public class NhanKhauController implements Initializable {
    ...
    public void dangKyTamVang(ActionEvent event) throws IOException {
        Utilities.popNewWindow(event, "/com/cnpm/chuc-nang-view/nhan-khau-chuc-nang-view/dang-ky-tam-vang.fxml");
    }

    @FXML
    public void dangKyTamTru(ActionEvent event) throws IOException {
        Utilities.popNewWindow(event, "/com/cnpm/chuc-nang-view/nhan-khau-chuc-nang-view/dang-ky-tam-tru.fxml");
    }
